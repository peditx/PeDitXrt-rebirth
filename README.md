...
## **فیچر های اصلی این اسکریپت**:
  - دوتا پسوال کامل (پسوال و پسوال۲) ٫ تغییر آی پی مین و اکس روت روی فلش به صورت ثابت وجود دارد. نسخه‌ای که نسخه مین هست روی همه دستگاه‌ها به جز x86 و X86-64 که فیچر اکس روت ندارند و اصلاً لازم ندارند.
